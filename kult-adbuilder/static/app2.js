...
(function() {
    ...
    // FIX #4: Debug logging — set window.AD_BUILDER_DEBUG = true in browser console to enable
    function _log(...a)  { if (window.AD_BUILDER_DEBUG) _log(...a); }
    function _err(...a)  { if (window.AD_BUILDER_DEBUG) _err(...a); }
    function _warn(...a) { if (window.AD_BUILDER_DEBUG) _warn(...a); }
