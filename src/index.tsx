                ...
                <div class="p-3 flex-1 overflow-y-auto"
                    ...
                    <div id="propertiesPanel" class="mb-2 hidden">
                        ...
                        <div class="space-y-2 bg-gray-900 rounded-lg p-3">
                            ...
                            <div id="commonPropertiesGrid" class="grid grid-cols-2 gap-2 pb-3 border-b border-gray-700">
                                <div>
                            ...
                            <div id="clickthroughProps" class="hidden space-y-2 pb-3 border-b border-gray-700">
                                ...
                                <div id="imageBorderRadius" class="hidden">
                                    <label class="text-sm text-gray-400">Border Radius</label>
                                    <input type="number" id="propImageBorderRadius" class="w-full bg-gray-800 rounded px-3 py-2 text-sm" placeholder="0" min="0" max="200" value="0">
                                </div>
                            </div>
                            ...
                            <div id="shapeProps" class="hidden space-y-2 pb-3 border-b border-gray-700">
                                ...
                                <div>
                                    ...
                                    <div class="flex items-center gap-2">
                                        <input type="color" id="propShapeColor" class="flex-1 h-10 bg-gray-800 rounded px-2 py-1">
                                        <label class="flex items-center gap-1 text-xs text-gray-400">
                                            <input type="checkbox" id="propShapeTransparent" class="w-4 h-4">
                                            <span>Transparent</span>
                                        </label>
                                    </div>
                                </div>
                                <div>
                                    <label class="text-sm text-gray-400">Border</label>
                                    <div class="grid grid-cols-3 gap-2">
                                        <div>
                                            <input type="number" id="propShapeBorderWidth" class="w-full bg-gray-800 rounded px-2 py-1 text-sm" placeholder="Width" min="0" max="50" value="0">
                                            <label class="text-xs text-gray-500">Width (px)</label>
                                        </div>
                                        <div>
                                            <input type="color" id="propShapeBorderColor" class="w-full h-10 bg-gray-800 rounded px-2 py-1" value="#000000">
                                            <label class="text-xs text-gray-500">Color</label>
                                        </div>
                                        <div>
                                            <input type="number" id="propShapeBorderRadius" class="w-full bg-gray-800 rounded px-2 py-1 text-sm" placeholder="Radius" min="0" max="200" value="0">
                                            <label class="text-xs text-gray-500">Radius (px)</label>
                                        </div>
                                    </div>
                                </div>
                                <div>
                    ...
                    <div class="mb-2">
                        ...
                        <div class="space-y-2">
                            <button id="saveProjectBtn" class="w-full bg-blue-600 hover:bg-blue-700 text-white py-2 rounded transition-colors">
                                <i class="fas fa-save mr-2"></i>Save Project
                            </button>
                            <button id="loadProjectBtn" class="w-full bg-indigo-600 hover:bg-indigo-700 text-white py-2 rounded transition-colors">
                                <i class="fas fa-folder-open mr-2"></i>Load Project
                            </button>
                            <input type="file" id="loadProjectInput" accept=".zip,application/zip" class="hidden">
                        </div>
                    </div>
            ...
            <div class="flex-1 flex flex-col">
                ...
                <div class="flex-1 flex flex-col overflow-hidden bg-gray-900">
                    ...
                    <div class="flex-shrink-0 bg-gray-800 border-t border-gray-700 p-4">
                        ...
                        <!-- Timeline Container -->
                        <div id="timelineContainer" class="bg-gray-900 rounded-lg overflow-x-auto relative" style="height: 215px;">
                            <div class="min-w-[800px]">
                                ...
                                <ul id="timelineTracks" class="overflow-y-auto bg-gray-800" style="max-height: 180px; list-style: none; padding: 0; margin: 0;">
                            ...
                            <!-- Zoom Controls -->
                            <div class="fixed bottom-8 right-8 flex items-center space-x-2 bg-gray-800 rounded-lg p-2 shadow-lg z-50">
